return {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<C-A-F10>", "<cmd>BufferLineCyclePrev<cr>", mode = { "i", "n" }, desc = "Prev Buffer" },
      { "<C-A-1>", "<cmd>BufferLineCyclePrev<cr>", mode = { "i", "n" }, desc = "Prev Buffer" },
      { "<C-]>", "<cmd>BufferLineCycleNext<cr>", mode = { "i", "n" }, desc = "Next Buffer" },
    },
    opts = {
      options = {
      -- stylua: ignore
