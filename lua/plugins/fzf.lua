...
return {
  ...
  keys = {
    ...
    { "<leader>fc", require("utils.pick").config_files(), desc = "Find Config File" },
    ...
    { "<leader>sG", require("utils.pick")("live_grep", { root = false }), desc = "Grep (cwd)" },
    ...
    { "<leader>sw", require("utils.pick")("grep_cword"), desc = "Word (Root Dir)" },
    { "<leader>sW", require("utils.pick")("grep_cword", { root = false }), desc = "Word (cwd)" },
    { "<leader>sw", require("utils.pick")("grep_visual"), mode = "v", desc = "Selection (Root Dir)" },
    { "<leader>sW", require("utils.pick")("grep_visual", { root = false }), mode = "v", desc = "Selection (cwd)" },
    { "<leader>uC", require("utils.pick")("colorschemes"), desc = "Colorscheme with Preview" },
    -- {
    --   "<leader>ss",
    --   function()
